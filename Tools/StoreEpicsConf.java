...
public class StoreEpicsConf
{
    ...
    public static void main(java.lang.String[] args)
    {
        ...
        {
            System.out.println("Usage:java StoreEpicsConf <experiment> [shot]");
            return;
        }
	...
	if(args.length == 2)
	{
	    ...
	    Tree tree = new Tree(experiment, shot);
			...
			recName = recName.trim();
                        System.out.println("Writing...."+recName);
			...
			if(valData instanceof Int8 || valData instanceof Uint8)
			   ...
			   valChan.put( valData.getStringArray());
                        ...
                        ctxt.pendIO(5.);
			System.out.println("Written value: " + valData);
