...
public class LoadEpicsConf
{
    ...
    public static void main(java.lang.String[] args)
    {
        ...
        {
            System.out.println("Usage:java LoadEpicsConf <experiment> [shot]");
            return;
        }
	...
	if(args.length == 2)
	{
		...
		tree = new Tree(experiment, shot);
			...
			recName = recName.trim();
                        System.out.println("Reading...."+recName);
			...
			System.out.println("Actual value: " + valData);
